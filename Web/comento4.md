...
단순히 기능을 구현하는 것이 아니라, **모든 사용자가 동등하게 웹을 이용할 수 있도록 돕는 것**이 프론트엔드 개발자의 중요한 역할임을 다시금 깨닫게 되었다.

이번 경험을 통해 웹 접근성에 대한 이해를 한층 더 깊이 다질 수 있었고, 실무에서도 반드시 적용해야 할 필수 역량이라는 확신을 가졌다.

특히, 웹 접근성은 단순한 `"옵션"`이 아니라 **법적 기준을 충족하고, 더 많은 사용자를 포용하는 필수 요소**라는 점에서, 앞으로도 지속적으로 고민하고 개선해 나갈 예정이다.

이 경험이 프론트엔드 개발자로서의 경쟁력을 더욱 강화해 줄 것이라 믿으며, 앞으로도 웹 접근성을 고려한 개발을 실천하는 개발자가 되고자 한다!